...
const LABELS = {
  ...
  beFirst: 'Be the first to rate this game.',
  noComments: 'No comments.',
  anonymous: 'Anonymous',
  formError: 'Enter a rating or write a comment.',
  currency: 'RSD',
  minSuffix: ' min',
  summaryTpl: 'Average rating: {avg} out of 5 — based on {rated} ratings, {total} comments.'
};
const LOCALE = 'en-GB';
